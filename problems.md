...
12. Print even numbers between 1 and 50.
...
## 🟠 Level 5 -- Dictionaries & Sets

41. Count frequency of elements using dictionary.
42. Invert a dictionary (swap keys and values).
...
46. Write recursive factorial function.
47. Recursive Fibonacci.
48. Recursive binary search.
49. Check if number is prime (optimized).
50. Find power using recursion (x\^n).

------------------------------------------------------------------------

## 🔵 Level 7 -- Pattern Printing

51. Print pyramid pattern.
52. Print inverted pyramid.
53. Print Floyd's triangle.
54. Print Pascal's triangle.

------------------------------------------------------------------------

## 🔴 Level 8 -- Beginner DSA Style Problems

55. Two Sum problem.
56. Valid Parentheses problem.
57. Maximum subarray (Kadane's algorithm).
58. Move all zeros to end of list.
